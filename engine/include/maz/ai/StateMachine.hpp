...
class StateMachine {
  ...
  private:
    ...
    std::unordered_map<maz::core::StringId, State, StringIdHash> m_states;
    // [from][event] = to
    std::unordered_map<maz::core::StringId, std::unordered_map<maz::core::StringId, maz::core::StringId, StringIdHash>, StringIdHash> m_transitions;
