...
(function (global) {
  ...
  const GENRES = {
    lofi: {
      ...
      fx: { reverb: 0.35, delay: 0.22, delayTime: 0.5, vinyl: 0.5, modFx: 'rotary', glue: 0.25, master: 1.15, sidechain: 0.14, brightness: 0.75 }
    },
    ...
    synthwave: {
      ...
      fx: { reverb: 0.42, delay: 0.3, delayTime: 0.375, vinyl: 0, modFx: 'flanger', glue: 0.25, master: 0.94, sidechain: 0.42, brightness: 1.05 }
    },
    ...
    house: {
      ...
      fx: { reverb: 0.4, delay: 0.24, delayTime: 0.375, vinyl: 0, modFx: 'phaser', glue: 0.3, master: 1.02, sidechain: 0.58, brightness: 1.0 }
    },
    ...
    ambient: {
      ...
      fx: { reverb: 0.8, delay: 0.35, delayTime: 0.75, vinyl: 0.15, modFx: 'phaser', glue: 0.05, master: 1.31, sidechain: 0, brightness: 0.9 }
    },
    ...
    cinematic: {
      ...
      fx: { reverb: 0.65, delay: 0.18, delayTime: 0.5, vinyl: 0, modFx: 'phaser', glue: 0.15, master: 1.10, sidechain: 0.12, brightness: 0.95 }
    },
    ...
    chiptune: {
      ...
      fx: { reverb: 0.16, delay: 0.26, delayTime: 0.1875, vinyl: 0, modFx: 'flanger', glue: 0.1, master: 1.38, sidechain: 0, brightness: 1.15 }
    },
    ...
    trap: {
      ...
      fx: { reverb: 0.35, delay: 0.2, delayTime: 0.375, vinyl: 0, modFx: 'phaser', glue: 0.3, master: 1.17, sidechain: 0.46, brightness: 0.95 }
    },
    ...
    rock: {
      ...
      fx: { reverb: 0.3, delay: 0.14, delayTime: 0.375, vinyl: 0, modFx: 'flanger', glue: 0.4, master: 0.92, sidechain: 0.08, brightness: 1.1 }
    },
    ...
    funk: {
      ...
      fx: { reverb: 0.22, delay: 0.18, delayTime: 0.375, vinyl: 0.08, modFx: 'phaser', glue: 0.45, master: 1.0, sidechain: 0.1, brightness: 1.05 }
    },
    ...
    jazz: {
      ...
      fx: { reverb: 0.42, delay: 0.12, delayTime: 0.5, vinyl: 0.12, modFx: 'rotary', glue: 0.15, master: 1.2, sidechain: 0, brightness: 0.9 }
    },
    ...
    disco: {
      ...
      fx: { reverb: 0.36, delay: 0.2, delayTime: 0.375, vinyl: 0.06, modFx: 'phaser', glue: 0.4, master: 0.98, sidechain: 0.3, brightness: 1.05 }
    },
    ...
    techno: {
      ...
      fx: { reverb: 0.3, delay: 0.26, delayTime: 0.375, vinyl: 0, modFx: 'flanger', glue: 0.3, master: 0.96, sidechain: 0.62, brightness: 1.0 }
    },
    ...
    drill: {
      ...
      fx: { reverb: 0.4, delay: 0.24, delayTime: 0.375, vinyl: 0, modFx: 'phaser', glue: 0.3, master: 1.12, sidechain: 0.4, brightness: 0.92 }
    },
    ...
    gospel: {
      ...
      fx: { reverb: 0.5, delay: 0.16, delayTime: 0.5, vinyl: 0.08, modFx: 'rotary', glue: 0.35, master: 1.08, sidechain: 0.1, brightness: 0.95 }
    },
    ...
    country: {
      ...
      fx: { reverb: 0.34, delay: 0.14, delayTime: 0.5, vinyl: 0.1, modFx: 'rotary', glue: 0.3, master: 1.1, sidechain: 0.06, brightness: 1.0 }
    }
  };
