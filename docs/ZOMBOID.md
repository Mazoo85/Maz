...
(up to +200% at ×5), so keeping the chain alive fills your wallet as well as your score.

---

## The enemies

Thirteen zombie types join the horde as the waves climb:
...
| 3 | **Boss** | Huge bullet-sponge that leads every 5th wave; ground-slams. **Enrages** below 35% health — faster, slams twice as often, and calls in waves of runners. |
