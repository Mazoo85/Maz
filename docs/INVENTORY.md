...
| app | header comment says what it shows | 168/168 (100%) |
...
documents itself. They are not spread evenly: 145 in `render`, 117 in `math`, 75 in `game`, 57
