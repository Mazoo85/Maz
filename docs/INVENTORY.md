...
| | Count | |
|---|---:|---|
| Native games and demos (`apps/`) | 179 | 38,625 lines |
...
| Documents (`docs/`) | 20 | |
| **Catalogued artifacts** | **922** | |

| Health signal | Score | |
|---|---:|---|
| Completeness checks passing | 88% | █████████░ 2857 of 3246 |
...
| Kind | Check | Passing |
|---|---|---:|
| engine-module | shown by a sample app | 330/697 (47%) |
