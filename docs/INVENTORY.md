...
| Health signal | Score | |
|---|---:|---|
| Completeness checks passing | 80% | ████████░░ 2496 of 3110 |
...
| Open tasks in the queue below | 22 | |
...
| web-app | has a logic test | 4/6 (67%) |
...
#### 2 browser projects have no tests at all
...
<sub>2 affected · effort: medium · value: ★★★ · queued below as the `web-app:tests` task</sub>
