...
- **Modulation** — automation of master-EQ-cutoff/FM/reverb/master/delay-mix/distortion-drive/stereo-width/**synth-filter-cutoff**/**synth-filter-resonance**/**bass-filter-cutoff**/**bass-filter-resonance**/**delay-feedback**/**reverb-size**/**bitcrusher-mix**/**pitch-shift** (semitone bends automated in real time)/**lead-bus volume**/**lead-bus pan**/**bass-bus volume**/**bass-bus pan**/**drum-bus volume**/**drum-bus pan**/**reverb-send**/**delay-send**/**master-pan** (the classic lead sweep + acid Q builds + bus volume rides on every bus + drum drops/builds + auto-pan + parallel-send risers/throws + whole-mix auto-pan), synced to the transport, from either an
