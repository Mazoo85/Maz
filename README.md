...
| 🎲 | **NAME MAKER** — [open](namemaker/) · [docs](namemaker/README.md) | Press a button, get a name: one adjective, one noun, from a thousand of each. Installs to a phone home screen and works offline. |
