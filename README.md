...
- **Sequencing** — a `Sequencer` channel rack (step grid with per-step velocity, **probability**, and **ratcheting**), **two** `PianoRoll`
  ...
  an **arpeggiator** (up/down/up-down/random/as-played, 1–4 octave range), a **global transpose**, a **metronome** with **count-in**, and **sidechain** ducking (with a selectable trigger channel).
